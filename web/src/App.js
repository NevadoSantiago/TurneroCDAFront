			...
			<Router>
				...
				<div className="container">
					<Switch>
						...
						<AuthRoutePrivate path="/nuevo" component={NuevoTurno} 
						...
						autorizado3={RECEPCION}
						autorizado4={null}  ></AuthRoutePrivate>
						<AuthRoutePrivate path="/editar" component={EditarPersona} 
						autorizado={ADMIN_SUCURSAL} 
						autorizado2={CONTROL_ES} 
						autorizado3={RECEPCION}
						autorizado4={null}   ></AuthRoutePrivate>
						<AuthRoutePrivate path="/listaES" exact component={ControlES} 
						autorizado={ADMIN_SUCURSAL} 
						autorizado2={null} 
						autorizado3={null}
						autorizado4={null} ></AuthRoutePrivate>
						<AuthRoutePrivate path="/listaRecepcion" exact component={Recepcion} 
						autorizado={ADMIN_SUCURSAL} 
						autorizado2={null} 
						autorizado3={null}
						autorizado4={null}   ></AuthRoutePrivate>
{/* 						<AuthRoutePrivate path="/administrarPersona" exact component={AdministrarPersonal}
						...
						autorizado3={null}
						autorizado4={null}  ></AuthRoutePrivate>
						<AuthRoutePrivate path="/" 
						component={Home} 
						autorizado={ADMIN_SUCURSAL} 
						autorizado2={CONTROL_ES} 
						autorizado3={RECEPCION}
						autorizado4={ADMIN_GENERAL} ></AuthRoutePrivate>
					</Switch>
				</div>
			</Router>
		)
