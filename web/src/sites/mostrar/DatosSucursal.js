			...
			<React.Fragment>
				...
				<div className="container" style={{ flex: 1, backgroundColor: 'white', padding: '20px', borderRadius: '15px', marginRight: '15px', marginLeft: '15px', marginBottom: '15px', textAlign: 'center' }}>
					<div style={{ margin: -5 }}>
						...
						<NavLink to={{ pathname: '/lista', sucursal: sucursal }} className="button is-rounded is-outlined" exact={true} activeClassName='button is-rounded is-outlined' style={{ margin: 5 }}>
                            <span className="icon">
...
export default connect(mapStateToProps, mapDispatchToProps)(DashboardAdministradorSucursal)