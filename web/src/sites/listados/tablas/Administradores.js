...
class DatosAdministradores extends React.Component {
    ...
    eliminarAdministrador = async (admin) => {      
        ...
        if (window.confirm("Seguro que desea eliminar el administrador " + admin.nombre + " " + admin.apellido + "?")) { 
...
export default connect(mapStateToProps, mapDispatchToProps)(DatosAdministradores)